...
class TextureShader extends Shader {
    constructor() {
        super("Shader/vsSimple.glsl", "Shader/prova2.glsl");

        /*this.program.textureFile = gl.getUniformLocation(this.program, "u_texture");
        this.program.DTexMix = gl.getUniformLocation(this.program, "DTexMix");
        ...
        this.program.lightType = gl.getUniformLocation(this.program, "lightType");
